                ...
                <transition enter-active-class="transition ease-out duration-100"
                  ...
                  <MenuItems
                    ...
                    <MenuItem v-for="item in userNavigation" :key="item.name" v-slot="{ active }"
                      @click="item.name === 'Sign out' ? handleLogout() : null">
...
const navigation = [
  ...
  { name: "Dose Personale", href: "/dose-personale", current: false },
  { name: "Dose Paziente", href: "/dose-paziente", current: false },
  { name: "Therabed", href: "/therabed", current: false },
  { name: "Sorgenti", href: "/sorgenti", current: false },
];
