      ...
      <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="flex h-16 items-center justify-between">
          <div class="flex items-center">
            <div class="shrink-0">
              <img class="w-24 mx-auto mb-0" src="@/assets/logo.png" alt="Physico" />
            </div>
      ...
      <DisclosurePanel class="md:hidden">
        ...
        <div class="border-t border-gray-700 pt-4 pb-3">
          ...
          <div class="mt-3 space-y-1 px-2">
            <DisclosureButton v-for="item in userNavigation" :key="item.name" as="a" :href="item.name !== 'Logout' ? item.href : null" @click="item.name === 'Logout' ? handleLogout() : null"
